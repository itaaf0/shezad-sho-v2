...
import { Suspense } from 'react'; // <-- ১. Suspense ইমপোর্ট করা হয়েছে

// useSearchParams() ব্যবহার করা কম্পোনেন্টটিকে একটি নতুন ফাংশনে নিয়ে যাওয়া হয়েছে
...
// ২. মূল এক্সপোর্ট ফাংশনটি এখন Suspense Boundary যোগ করছে
