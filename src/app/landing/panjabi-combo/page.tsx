...
export default async function PanjabiComboLandingPage() {
  const landingProducts = await getProducts("Katan Panjabi");
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl font-headline inline-flex items-center gap-2">
              ...
              Katan Panjabi & Coat Combos
              <Sparkles className="text-primary"/>
            </h2>
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Handpicked for elegance and style. Limited edition items available.
            </p>
          </div>
